...
puts "cleaning 4"
 ...
 chiang = Artist.create(name: "Chiang Mai", bio: "")
...
pie_gibet = Artwork.create(title: "la Pie sur le Gibet", completion_year: 1568, description: "", location: "", collection: classic, artist: brueghel)
